...
const path = require('path'); // para caminhos relativos no node
...
//mongoose.connect('mongodb+srv://amattos:<password>@cluster0-kaspy.mongodb.net/test?retryWrites=true&w=majority', {
